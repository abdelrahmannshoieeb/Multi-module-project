...
use App\Http\Controllers\Api\V1\MarketPlaceCategoriesController;
use App\Http\Controllers\Api\V1\NotificationController;
use App\Http\Controllers\Api\V1\StoreMarketController;
...
Route::group(['middleware'=>['ensure.correct.data.type','localization'],'namespace' => 'Api\V1'], function () {
        ...
        Route::get('users-activity', [NotificationController::class,"getUserActivities"]);

        Route::post('placev2', 'OrderController@proceed_place_order');
    // marketplace module
        Route::get('/favourites/{id}', [MarketPlaceCategoriesController::class, 'get_favorites']);
        Route::get('/market-categories', [MarketPlaceCategoriesController::class, 'get']);
        Route::get('/get-categories-with-sub', [MarketPlaceCategoriesController::class, 'get_categories_with_sub']);
        Route::get('/get-pharmacy', [MarketPlaceCategoriesController::class, 'get_pharmacy']);


        Route::get('/search-supermarket', [MarketPlaceCategoriesController::class, 'search_supermarket']);
        Route::post('/sell-product', [MarketPlaceCategoriesController::class, 'sell_product']);
        Route::get('/marketplace/get-categories', [MarketPlaceCategoriesController::class, 'get_categories']);
        Route::get('/marketplace/seller-profile', [MarketPlaceCategoriesController::class, 'get_seller_profile']);
        Route::get('/marketplace/products', [MarketPlaceCategoriesController::class, 'get_products']);
        Route::get('/marketplace/recently-viewed', [MarketPlaceCategoriesController::class, 'get_recently_viewed_products']);
        Route::get('/marketplace/category/products', [MarketPlaceCategoriesController::class, 'get_products_by_categoryId']);
        Route::get('/marketplace/favourites/{id}', [MarketPlaceCategoriesController::class, 'get_favorites']);
        Route::post('/marketplace/add-to-favourites', [MarketPlaceCategoriesController::class, 'store_favourite']);
        Route::get('/marketplace/last_viewed_stores', [MarketPlaceCategoriesController::class, 'get_last_viewed_stores']);
        Route::get('/marketplace/favourite_stores/{id}', [MarketPlaceCategoriesController::class, 'get_favourite_stores']);

        Route::prefix('store')->controller(StoreMarketController::class)->group(function(){

            Route::get('/', 'get');
            Route::get('sub-categories', 'get_sub_categories');
            Route::get('categories', 'get_categories');
            Route::get('category-stores', 'get_stores');
            Route::get('items', 'get_store_items');
            Route::get('items/categories', 'get_items_categories');
            Route::get('search-keyword', 'search_keyword');
            Route::get('search-sub-category', 'search_sub_category');
            Route::get('item', 'get_item');
            Route::post('prescription', 'store_prescription');
            Route::get('/get-categories-with-sub', 'get_category_with_sub');
        ...
        Route::get('/market-categories', [MarketPlaceCategoriesController::class, 'get']);
        Route::get('/get-categories', [MarketPlaceCategoriesController::class, 'get_categories']);
        Route::get('/seller-profile', [MarketPlaceCategoriesController::class, 'get_seller_profile']);
        Route::get('/products', [MarketPlaceCategoriesController::class, 'get_products']);
        Route::get('/category/products', [MarketPlaceCategoriesController::class, 'get_products_by_categoryId']);
        Route::get('/favourites/{id}', [MarketPlaceCategoriesController::class, 'get_favorites']);
        Route::post('/add-to-favourites', [MarketPlaceCategoriesController::class, 'store_favourite']);

        Route::get('settings/{key}', 'ConfigController@getSetting');

        Route::get('GetStoresReviews/storeid/{store_id}/moduleid/{module_id}' , 'ConfigController@get_store_reviews');
        Route::post('AddStoresReviews', 'ConfigController@add_store_reviews');

        Route::get('categories-banners/{module_id}','ConfigController@getAllCategoriesAndBannersByModuleId');
        Route::get('categories-with-subcategories', 'ConfigController@getCategoriesWithSubcategories');
        Route::get('subcategories-stores/{category_id}', 'ConfigController@getSubcategoriesAndStores');
        Route::get('stores-by-subcategory/{subcategory_id}', 'ConfigController@getStoresBySubcategoryId');
        Route::post('create-appointment', 'ConfigController@createAppointment');

        Route::get('/top-pharmacies-pharma/{module_id}', 'ConfigController@TopPharmaciesPharma');
        Route::get('/nearby-you-pharma/{module_id}', 'ConfigController@NearbyYouPharma');
        Route::get('/opened-pharma/{module_id}', 'ConfigController@Opened');
        Route::get('/get-all-pharmacy/{module_id}', 'ConfigController@get_all_pharmacy');



    // bookingtable
    Route::post('bookingtable', 'OrderController@bookingtable');

    Route::post('bookingtable', 'OrderController@bookingtable');


     // Food module
     Route::get('food/{module_id}/TopRestaurant', 'ConfigController@TopRestaurant');
     Route::get('food/{module_id}/NearbyYou', 'ConfigController@NearbyYou');
     Route::get('food/{module_id}/Recommended', 'ConfigController@Recommended');

     // Store module
     Route::get('stores/{module_id}/TopSupermarkets', 'ConfigController@TopSupermarkets');
     Route::get('stores/{module_id}/TopPharmacies', 'ConfigController@TopPharmacies');
     Route::get('stores/{module_id}/TopHousehold', 'ConfigController@TopHousehold');
     Route::get('stores/{module_id}/TopElectronics', 'ConfigController@TopElectronics'); // Changed to TopElectronics

     // Pharma module
     Route::get('pharma/{module_id}/TopPharmacies', 'ConfigController@TopPharmacies');
     Route::get('pharma/{module_id}/NearbyYou', 'ConfigController@NearbyYou');
     Route::get('pharma/{module_id}/Opened', 'ConfigController@Opened');

     // Services module
     Route::get('services/{module_id}/TopRated', 'ConfigController@TopRated');
     Route::get('services/{module_id}/NearbyYou', 'ConfigController@NearbyYou');
     Route::get('services/{module_id}/GetItemslist', 'ConfigController@get_items_services');
...
//  fff
    ...
    Route::get('fee', 'CustomerController@getManagementFee');
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::group(['middleware'=>['dm.api']], function () {
            ...
            Route::post('make-collected-cash-payment', 'DeliverymanController@make_payment')->name('make_payment_delivery');
            Route::post('make-wallet-adjustment', 'DeliverymanController@make_wallet_adjustment')->name('make_wallet_adjustment_delivery');
            Route::get('wallet-payment-list', 'DeliverymanController@wallet_payment_list')->name('wallet_payment_list_delivery');
            ...
            Route::group(['prefix' => 'message'], function () {
                // ============================================
                Route::get('list/{user_id}', 'ConversationController@dm_conversations');
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor'], function () {
        ...
        Route::post('make-collected-cash-payment', 'VendorController@make_payment')->name('make_cash_payment');
        Route::post('make-wallet-adjustment', 'VendorController@make_wallet_adjustment')->name('make_wallet_adjustmentـvendor');
    ...
    Route::group(['prefix' => 'customer/wish-list'], function () {
        Route::get('/', 'WishlistController@wish_list')->withoutMiddleware(['ensure.correct.data.type']);
    ...
    Route::group(['middleware'=>['module-check']], function(){
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
            ...
            // Chatting
            Route::group(['prefix' => 'message'], function () {
                Route::get('list/{user_id}', 'ConversationController@conversations');
                Route::get('search-list', 'ConversationController@search_conversations');
                Route::get('details', 'ConversationController@messages');
                Route::post('send', 'ConversationController@messages_store');
            });
            ...
            //     Route::get('/', 'WishlistController@wish_list')->withoutMiddleware(['ensure.correct.data.type']);
            //     Route::post('add', 'WishlistController@add_to_wishlist')->withoutMiddleware(['auth:api']);
        ...
        Route::group(['prefix' => 'customer', 'middleware' => 'apiGuestCheck'], function () {
            Route::group(['prefix' => 'order'], function () {
                ...
                Route::post('place', 'OrderController@proceed_place_order');

                Route::post('checkout', 'OrderController@place_order');
                // proceed_place_order
