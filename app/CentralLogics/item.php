...
class ProductLogic
{
    ...
    public static function get_latest_products($zone_id,  $store_id, $category_id, $type, $min=false, $max=false, $product_id=null)
    {
        if($category_id != 0){
    ...
    public static function get_new_products($zone_id, $type, $min=false, $max=false,$product_id=null, $filter = null, $rating_count = null)
    {
    ...
    public static function recommended_items($zone_id,$store_id=null, $type='all', $filter='all')
    {
        $data =[];
    ...
    public static function popular_products($zone_id,  $type = 'all')
    {
    ...
    public static function most_reviewed_products($zone_id,  $type = 'all')
    {
    ...
    public static function discounted_products($zone_id,  $type = 'all', $category_ids = null, $filter = null,$min=false, $max=false, $rating_count = null)
    {
    ...
    public static function cart_suggest_products($zone_id,$store_id, $type='all',$recomended=false)
    {
        $data =[];
    ...
    public static function get_popular_basic_products($zone_id,  $type, $store_id =null, $category_id=null, $min=false, $max=false,$product_id=null)
    {
