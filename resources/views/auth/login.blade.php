...
<main id="content" role="main" class="main">
    <div class="auth-wrapper">
        <div class="auth-wrapper-left" style="background: url({{asset('public/cf70a594-7951-4c45-80ac-d5d1cd3e4fb1.jpeg')}}) no-repeat center left/cover !important;">
        ...
        <div class="auth-wrapper-right">
            <label class="badge badge-soft-success __login-badge">
                 <a href="https://noouh.com/"> Developed By: Noouh For Integrated Solutions </a>
            </label>

            <!-- Card -->
            <div class="auth-wrapper-form">
            @php($store_logo = \App\Models\BusinessSetting::where(['key' => 'logo'])->first()->value)
                <img class="onerror-image" style="width:50%"  data-onerror-image="{{asset('/public/assets/admin/img/favicon.png')}}"
