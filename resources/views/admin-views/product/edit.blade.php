                    ...
                    <div class="card shadow--card-2 border-0">
                        ...
                        <div class="card-body">
                            <div id="add_new_option">
                                ...
                                @if (isset($product->variations_all) && count($product->variations_all,true)>0)
                                    @foreach ($product->variations_all as $key_choice_options => $item)
                                        @if (isset($item['price']))
                                        @break
                                ...
                                <!-- Empty Variation -->
                                @if (!isset($product->variations_all) || count($product->variations_all,true)<1)
...
<script>
    ...
    let count = {{ isset($product->variations_all) ? count($product->variations_all) : 0 }};
