...
$(document).ready(function() {
    ...
    // Using 'on' for dynamically added elements
    $(document).on('click', '#add_new_option_button', function(e) {
                ...
                <div>
                    ...
                    <div class="row g-2">
                        <div class="col-xl-4 col-lg-6">
                            <label class="form-check form--check">
                            <span class="form-check-label">{{ translate('Select Option') }}</span>
                            <select id="options[` + count + `][name]" name="options[` + count + `][name]" class="form-control">
    ...
    // Using 'on' to handle click event for dynamically added delete buttons
    $(document).on('click', '.delete_input_button', function() {
        $(this).closest('.view_new_option').remove();
    });

    // Handle the dynamically added "Add New Row" button click event
    $(document).on('click', '.add_new_row_button', function() {
        ...
        let new_row_html = `
            <div class="row g-3 add_new_view_row_class mb-3">
                <div class="col-md-4 col-sm-6">
                    <label for="">{{ translate('Option_name') }}</label>
                    <input class="form-control" required type="text" name="options[` + count + `][values][label]" id="">
                </div>
                <div class="col-md-4 col-sm-6">
                    <label for="">{{ translate('Additional_price') }}</label>
                    <input class="form-control" required type="number" min="0" step="0.01" name="options[` + count + `][values][optionPrice]" id="">
                </div>
            </div>`;
        $("#option_price_view_" + count).append(new_row_html);
    });
